export const HOST_URL = import.meta.env.VITE_NUTRIENGINE_HOST;
export const CREATE_USER_URL = `${HOST_URL}/users/signUp`;
export const ADMIN_SAVE_PROFILE = `${HOST_URL}/admin/save-data`;
